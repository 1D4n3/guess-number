...
* Из Packagist:
    ...
    * Выполнить команду composer require 1D4n3/guess-number; Перейти в каталог vendor/bin; Запустить Командную строку и ввести "php guess-number.php".
    * Ссылки Packagist: 1D4n3/guess-number
